define('emberjs-2018/src/ui/routes/application/route', ['exports'], function (exports) {
  'use strict';
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return new Ember.RSVP.Promise(function (resolve) {
                    return Ember.run.later(resolve, 2000);
                  });

                case 2:
                  return _context.abrupt('return', { filename: "tomster", filetype: "png" });
